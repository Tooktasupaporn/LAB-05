...
2). ทดลองเรื่องจำนวนของอาร์กิวเมนต์ในคำสั่ง Console.WriteLine()
 ...
 2.1). แก้โปรแกรมตามรูปด้านล่างนี้
  ...
  ![](https://github.com/Tooktasupaporn/LAB-05/blob/master/lab5-1.PNG?raw=true)
<hr>
<hr>
<hr>
<hr>
...
-เครื่องหมาย { }  ในคำสั่ง Console.WriteLine()ใช้ในการบอกตำแหน่งของผลลัพธ์ที่เนสต้องการให้แสดงผลออกมา 
<hr>
<hr>
<hr>
<hr>
...
ใช้ได้ เพราะเป็นการระบุเพื่อบอกตำแหน่งที่จะให้แสดงออกมา อยากให้แสดงที่ตำแหน่งไหนก็ใส่ตัวเลขตำแหน่งใน {} 
<hr>
<hr>
<hr>
<hr>
...
3). ทดลองเรื่องการกำหนดความกว้างของอาร์กิวเมนต์
  ...
  ![](https://github.com/Tooktasupaporn/LAB-05/blob/master/lab5-4.PNG?raw=true)
<hr>
<hr>
<hr>
<hr>
...
คือเลขข้างหน้าเป็นการบอกอาร์กิวเมนต์และตัวเลขข้างหลังเป็นการบอกตำแหน่งตัวสุดท้ายที่เราจะให้แสดงผลออกมา
<hr>
<hr>
<hr>
<hr>
